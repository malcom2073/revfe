			...
			Rectangle {
				...
				Rectangle {
					...
					Button {
						...
						width:70
						height:70
						text: propertyMap.HDRADIO_PRESET1
						onClicked: {
					...
					Button {
						...
						width:70
						height:70
						text: propertyMap.HDRADIO_PRESET2
						onClicked: {
					...
					Button {
						...
						width:70
						height:70
						text: propertyMap.HDRADIO_PRESET3
						onClicked: {
					...
					Button {
						...
						width:70
						height:70
						text: propertyMap.HDRADIO_PRESET4
						onClicked: {
					...
					Button {
						...
						width:70
						height:70
						text: propertyMap.HDRADIO_PRESET5
						onClicked: {
					...
					Button {
						...
						width:70
						height:70
						text: propertyMap.HDRADIO_PRESET6
						onClicked: {
